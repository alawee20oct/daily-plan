...
<body>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="input-group mb-2">
                        <input type="text" class="form-control" placeholder="Add New Team" id="add-team">
    ...
    <script>
        ...
        function settingTeam() {
            ...
            var teams = "";
            for (var i = 0; i < list_team.teams.length; i++) {
                var item = list_team.teams[i];
                teams += '<tr>';
                    teams += '<td>'+(i+1)+'</td>';
                    teams += '<td align="center"><input type="text" class="form-control" value="'+item.team+'" id="edit-'+item.id+'"></td>';
                    teams += '<td align="end"><btton class="btn btn-outline-success"><i class="bi bi-pencil-square" id="EDIT-'+item.id+'"></i></btton></td>';
                    teams += '<td align="center"><btton class="btn btn-outline-danger"><i class="bi bi-trash3-fill" id="DELETE-'+item.id+'"></i></btton></td>';
                teams += '</tr>';
            }
